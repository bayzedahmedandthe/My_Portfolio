            ...
            <div className="navbar text backdrop-blur-3xl fixed text-white z-20">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul
                            ...
                            <button className='flex items-center gap-1 bg-gradient-to-l px-2 py-1 from-purple-700 to-orange-700 rounded-sm hover:shadow-purple-500/95 shadow-xl'><a href="https://drive.google.com/file/d/1QI0oUih78R1d1m2Y3lUT-nCQonSutkuy/view?usp=sharing"> Resume</a> <img className='h-6 w-6' src={resume_logo} alt="" /></button>
                        </ul>
                    </div>
                ...
                <div className="navbar-end hidden lg:flex">
                    <ul className="flex items-center gap-4 text-lg">
                        ...
                        <button className='flex items-center gap-1 bg-gradient-to-l from-purple-700 to-orange-700 rounded-sm hover:shadow-purple-500/95 shadow-xl btn'><a href="https://drive.google.com/file/d/1QI0oUih78R1d1m2Y3lUT-nCQonSutkuy/view?usp=sharing"> Resume</a> <img className='h-6 w-6' src={resume_logo} alt="" /></button>
                    </ul>
                </div>
            </div>
        </div>
