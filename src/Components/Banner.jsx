...
const Banner = () => {
    return (
        <div className=" bg-[url('https://i.ibb.co.com/fd8fqj7Q/6434-removebg-preview.png')] bg-cover md:w-full w-[94%] mx-auto">
            <div className="flex items-center justify-around  backdrop-blur-xl">
                {/* title and description container */}
                <div className="md:space-y-3 md:pt-28 lg:pt-0 pt-28">
                    <h4 className="md:text-3xl font-semibold text-sm text-white">Hello, I am </h4>
                    ...
                    <h3 className="text-lg md:text-2xl font-semibold md:mt-2 text-white">Frontend developer</h3>
                    <p className="text-white md:font-medium">I like to create attractive websites</p>
                    <div className="lg:flex lg:justify-end lg:mt-12 mt-4">
                    ...
                    <div className="flex items-center lg:justify-center lg:gap-4 gap-2 lg:mt-12 mt-4">
                ...
                {/* img container */}
                <div>
                    <img className="md:w-full md:h-full h-[220px] w-[260px]" src={bayzed} alt="Bayzed" />
                </div>
            </div>
        </div>
    );
