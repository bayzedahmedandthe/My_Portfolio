...
const educationData = [
 ...
 <section className=" py-20 px-6 md:px-20">
      ...
      <div className="relative max-w-4xl mx-auto before:absolute before:left-8 before:top-0 before:bottom-0 before:w-1 before:bg-indigo-500">
        {educationData.map((edu, idx) => (
          ...
          >
            <div className="absolute left-0 top-2 w-10 h-10 rounded-full bg-indigo-600 flex items-center justify-center text-white shadow-lg">
