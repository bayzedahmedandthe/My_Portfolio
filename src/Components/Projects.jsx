...
const Projects = () => {
    return (
        <div id="projects" className="w-[90%] mx-auto my-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 grid-cols-2 md:gap-12">
                <div className="">
                ...
                <div className="">
                    ...
                    <h2 className="relative bottom-28 left-20 md:text-2xl text-xl font-semibold">Job Portal</h2>
                    <Link to="/jobPortal">
                        <button className="  md:text-xl text-lg relative bottom-24 -right-36 bg-gradient-to-l px-2 py-1 from-purple-700 to-orange-700 rounded-sm hover:shadow-purple-500/95 shadow-lg ">View More</button>
                    </Link>
                </div>
                <div className="">
                    ...
                    <h2 className="relative bottom-28 left-20 md:text-2xl text-xl font-semibold">Service Review</h2>
