        ...
        <div id="projects" className=" lg:w-10/12 w-[90%] mx-auto my-8">
            ...
            <div className="flex gap-8">
                ...
                <div className="flex-1">
                    <h3 className="text-xl text-gray-100 pt-2">Bistro Boss Restaurant</h3>
                    ...
                    <div className="flex items-center gap-6 pt-4">
                        ...
                        <div className="button-wrapper hover:shadow-md hover:shadow-green-500">
                            <button className='animated-border-button px-4 py-1'><a target="_blank" href="https://github.com/bayzedahmedandthe/Dev_Discuss_Server"> Backend code </a></button>
                        </div>
                    </div>
                </div>
            </div>
